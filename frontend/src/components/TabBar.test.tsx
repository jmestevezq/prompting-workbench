...
describe('TabBar', () => {
  it('renders all items', () => {
    render(<TabBar items={items} active="tab1" onChange={() => {}} />)
  ...
  it('applies active styling to the active item', () => {
    ...
    expect(activeBtn.className).toContain('text-indigo-600')
  })
  ...
  it('calls onChange with the item key when clicked', () => {
    ...
    render(<TabBar items={items} active="tab1" onChange={onChange} />)
